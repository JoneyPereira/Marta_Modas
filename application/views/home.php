      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Moda infantil</h4>
            <div class="card-body">
				<a href="#"><img class="card-img-top" src="<?php echo base_url()?>assets/img/infantil/img-moda-infantil-01.jpg" alt=""></a>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Moda masculina</h4>
            <div class="card-body">
				<a href="#"><img class="card-img-top" src="<?php echo base_url()?>assets/img/masculina/img-moda-masculina-01.jpg" alt=""></a>
            </div>
            <div class="card-footer">
              <a href="#" class="btn btn-primary">Veja mais</a>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Moda feminina</h4>
            <div class="card-body">
